...
class ExamsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['VisitMeetings', 'ExamTypes']
        ];
    ...
    public function view($id = null)
    {
        $exam = $this->Exams->get($id, [
            'contain' => ['VisitMeetings', 'ExamTypes', 'ExamEvidences', 'ExamNotes']
        ]);
    ...
    public function add()
    {
        ...
        $visitMeetings = $this->Exams->VisitMeetings->find('list', ['limit' => 200]);
        $examTypes = $this->Exams->ExamTypes->find('list', ['limit' => 200]);
        $this->set(compact('exam', 'visitMeetings', 'examTypes'));
        $this->set('_serialize', ['exam']);
    }
