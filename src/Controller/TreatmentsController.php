...
class TreatmentsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['VisitMeetings', 'TreatmentTypes']
        ];
    ...
    public function view($id = null)
    {
        $treatment = $this->Treatments->get($id, [
            'contain' => ['VisitMeetings', 'TreatmentTypes', 'TreatmentRequirements']
        ]);
    ...
    public function add()
    {
        ...
        $visitMeetings = $this->Treatments->VisitMeetings->find('list', ['limit' => 200]);
        $treatmentTypes = $this->Treatments->TreatmentTypes->find('list', ['limit' => 200]);
        $this->set(compact('treatment', 'visitMeetings', 'treatmentTypes'));
        $this->set('_serialize', ['treatment']);
    }
