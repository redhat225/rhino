<div class="col l2 m2 s2 center" id="side-control-panel">
    ...
    <ul id="game-gift-menu" class="left-align black">  
        ...
        <li style="border-top:1px solid white;"><a href="/doctor/doctors/view"><i class="ion-ios-skipbackward white-text small"></i>Retour</a></li>
...
<div class="col l10 m10 s10 info-dmp-container">
  ...
  <div class="container">
    <div class="container">
       ...
       <?= $this->Form->create(null,['class'=>'admin-form dash-form','id'=>'edit-doctor-account-form','type'=>'file']) ?>
                 ...
                 <h6 class="dmp-main-color bold" style="border-bottom:1px dashed navy;"><i class="ion-ios-contact dmp-main-color medium" style="padding-right:10px;"></i><?= h(__('Avatar')) ?></h6>
                  <?php if(!(empty($doctor->avatar_doctor))) :?>
                  <div class="col s12">
                    <?= $this->Html->image('doctor/doctor_avatar/'.$doctor->avatar_doctor,['class'=>'circle','width'=>'100px;']) ?>
                  </div>
                  <?php endif; ?>              
                  ...
                  <h6 class="dmp-main-color bold" style="border-bottom:1px dashed navy;"><i class="ion-ios-checkmark-outline dmp-main-color medium" style="padding-right:10px;"></i><?= h(__('Login')) ?></h6>
                    ...
                    <div class="input-field col s12">
                         <input id="username" name="username" type="text" class="required" length="25" value="<?= $doctor->username ?>"/>
...
<?= $this->Html->script('Red/doctor/doctors/edit',['block'=>true]) ?>
