...
<div class="pharmacyCustomers index large-9 medium-8 columns content">
    <h3><?= __('Pharmacy Customers') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th><?= $this->Paginator->sort('ispatient') ?></th>
                <th class="actions"><?= __('Actions') ?></th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($pharmacyCustomers as $pharmacyCustomer): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $pharmacyCustomer->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $pharmacyCustomer->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $pharmacyCustomer->id], ['confirm' => __('Are you sure you want to delete # {0}?', $pharmacyCustomer->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
