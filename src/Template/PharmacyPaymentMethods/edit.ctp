<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $pharmacyPaymentMethod->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $pharmacyPaymentMethod->id)]
            )
        ?></li>
...
<div class="pharmacyPaymentMethods form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Pharmacy Payment Method') ?></legend>
        <?php
