<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $requirementInteraction->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $requirementInteraction->id)]
            )
        ?></li>
...
<div class="requirementInteractions form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Requirement Interaction') ?></legend>
        <?php
