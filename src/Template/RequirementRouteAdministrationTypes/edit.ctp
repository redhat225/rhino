<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $requirementRouteAdministrationType->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $requirementRouteAdministrationType->id)]
            )
        ?></li>
...
<div class="requirementRouteAdministrationTypes form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Requirement Route Administration Type') ?></legend>
        <?php
