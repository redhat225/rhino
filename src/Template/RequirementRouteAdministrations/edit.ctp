<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $requirementRouteAdministration->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $requirementRouteAdministration->id)]
            )
        ?></li>
...
<div class="requirementRouteAdministrations form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Requirement Route Administration') ?></legend>
        <?php
