...
<div class="visitTypes index large-9 medium-8 columns content">
    <h3><?= __('Visit Types') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $visitType->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $visitType->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $visitType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $visitType->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
