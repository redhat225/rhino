 ...
 *
 */
class AuxiliariesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'avatar_auxiliary' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'avatar_auxiliary' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
