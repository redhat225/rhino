 ...
 *
 */
class DiaryTokensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'diary_token' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'delay' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'tracking_code' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'patient_id' => 1,
            'doctor_id' => 1,
            'diary_token' => 'Lorem ipsum dolor sit amet',
            'delay' => 1,
            'tracking_code' => 'Lorem ipsum dolor sit amet',
            'created' => '2016-11-24 18:22:16'
        ],
    ];
}
