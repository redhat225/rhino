...
/**
 * ManagerOperatorsFixture
 *
 */
class ManagerOperatorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'avatar_manager' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'avatar_manager' => 'Lorem ipsum dolor sit amet',
            'institution_id' => 1
        ],
    ];
}
