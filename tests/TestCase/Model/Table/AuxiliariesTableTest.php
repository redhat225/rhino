...
use App\Model\Table\AuxiliariesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AuxiliariesTable Test Case
 */
class AuxiliariesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AuxiliariesTable
     */
    public $Auxiliaries;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Auxiliaries') ? [] : ['className' => 'App\Model\Table\AuxiliariesTable'];
        $this->Auxiliaries = TableRegistry::get('Auxiliaries', $config);
    }
