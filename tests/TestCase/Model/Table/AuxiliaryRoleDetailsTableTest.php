...
use App\Model\Table\AuxiliaryRoleDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AuxiliaryRoleDetailsTable Test Case
 */
class AuxiliaryRoleDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AuxiliaryRoleDetailsTable
     */
    public $AuxiliaryRoleDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AuxiliaryRoleDetails') ? [] : ['className' => 'App\Model\Table\AuxiliaryRoleDetailsTable'];
        $this->AuxiliaryRoleDetails = TableRegistry::get('AuxiliaryRoleDetails', $config);
    }
    ...
    {
        unset($this->AuxiliaryRoleDetails);
