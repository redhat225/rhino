...
use App\Model\Table\CountryTownshipsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CountryTownshipsTable Test Case
 */
class CountryTownshipsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CountryTownshipsTable
     */
    public $CountryTownships;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CountryTownships') ? [] : ['className' => 'App\Model\Table\CountryTownshipsTable'];
        $this->CountryTownships = TableRegistry::get('CountryTownships', $config);
    }
