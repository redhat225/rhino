...
use App\Model\Table\DiaryTypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DiaryTypesTable Test Case
 */
class DiaryTypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DiaryTypesTable
     */
    public $DiaryTypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DiaryTypes') ? [] : ['className' => 'App\Model\Table\DiaryTypesTable'];
        $this->DiaryTypes = TableRegistry::get('DiaryTypes', $config);
    }
