...
use App\Model\Table\DoctorActDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DoctorActDetailsTable Test Case
 */
class DoctorActDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DoctorActDetailsTable
     */
    public $DoctorActDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DoctorActDetails') ? [] : ['className' => 'App\Model\Table\DoctorActDetailsTable'];
        $this->DoctorActDetails = TableRegistry::get('DoctorActDetails', $config);
    }
