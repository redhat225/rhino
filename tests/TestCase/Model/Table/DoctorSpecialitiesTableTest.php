...
use App\Model\Table\DoctorSpecialitiesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DoctorSpecialitiesTable Test Case
 */
class DoctorSpecialitiesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DoctorSpecialitiesTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DoctorSpecialities') ? [] : ['className' => 'App\Model\Table\DoctorSpecialitiesTable'];
        $this->DoctorSpecialities = TableRegistry::get('DoctorSpecialities', $config);
    }
