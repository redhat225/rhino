...
use App\Model\Table\DoctorSpecialityDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\DoctorSpecialityDetailsTable Test Case
 */
class DoctorSpecialityDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\DoctorSpecialityDetailsTable
     */
    public $DoctorSpecialityDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DoctorSpecialityDetails') ? [] : ['className' => 'App\Model\Table\DoctorSpecialityDetailsTable'];
        $this->DoctorSpecialityDetails = TableRegistry::get('DoctorSpecialityDetails', $config);
    }
    ...
    {
        unset($this->DoctorSpecialityDetails);
