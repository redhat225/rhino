...
use App\Model\Table\ExaminerOperatorActDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ExaminerOperatorActDetailsTable Test Case
 */
class ExaminerOperatorActDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ExaminerOperatorActDetailsTable
     */
    public $ExaminerOperatorActDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ExaminerOperatorActDetails') ? [] : ['className' => 'App\Model\Table\ExaminerOperatorActDetailsTable'];
        $this->ExaminerOperatorActDetails = TableRegistry::get('ExaminerOperatorActDetails', $config);
    }
    ...
    {
        unset($this->ExaminerOperatorActDetails);
