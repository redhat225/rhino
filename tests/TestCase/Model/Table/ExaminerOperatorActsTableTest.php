...
use App\Model\Table\ExaminerOperatorActsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ExaminerOperatorActsTable Test Case
 */
class ExaminerOperatorActsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ExaminerOperatorActsTable
     */
    public $ExaminerOperatorActs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ExaminerOperatorActs') ? [] : ['className' => 'App\Model\Table\ExaminerOperatorActsTable'];
        $this->ExaminerOperatorActs = TableRegistry::get('ExaminerOperatorActs', $config);
    }
    ...
    {
        unset($this->ExaminerOperatorActs);
