...
use App\Model\Table\InstitutionAdressesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\InstitutionAdressesTable Test Case
 */
class InstitutionAdressesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\InstitutionAdressesTable
     */
    public $InstitutionAdresses;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('InstitutionAdresses') ? [] : ['className' => 'App\Model\Table\InstitutionAdressesTable'];
        $this->InstitutionAdresses = TableRegistry::get('InstitutionAdresses', $config);
    }
    ...
    {
        unset($this->InstitutionAdresses);
