...
use App\Model\Table\InstitutionDoctorsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\InstitutionDoctorsTable Test Case
 */
class InstitutionDoctorsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\InstitutionDoctorsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('InstitutionDoctors') ? [] : ['className' => 'App\Model\Table\InstitutionDoctorsTable'];
        $this->InstitutionDoctors = TableRegistry::get('InstitutionDoctors', $config);
    }
