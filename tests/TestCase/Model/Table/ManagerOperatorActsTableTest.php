...
use App\Model\Table\ManagerOperatorActsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ManagerOperatorActsTable Test Case
 */
class ManagerOperatorActsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ManagerOperatorActsTable
     */
    public $ManagerOperatorActs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ManagerOperatorActs') ? [] : ['className' => 'App\Model\Table\ManagerOperatorActsTable'];
        $this->ManagerOperatorActs = TableRegistry::get('ManagerOperatorActs', $config);
    }
    ...
    {
        unset($this->ManagerOperatorActs);
