...
use App\Model\Table\ManagerOperatorsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ManagerOperatorsTable Test Case
 */
class ManagerOperatorsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ManagerOperatorsTable
     */
    public $ManagerOperators;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ManagerOperators') ? [] : ['className' => 'App\Model\Table\ManagerOperatorsTable'];
        $this->ManagerOperators = TableRegistry::get('ManagerOperators', $config);
    }
    ...
    /**
     * Test findAuthManager method
     *
     * @return void
     */
    public function testFindAuthManager()
    {
        $this->markTestIncomplete('Not implemented yet.');
    }
}
