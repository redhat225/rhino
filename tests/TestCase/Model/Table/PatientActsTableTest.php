...
use App\Model\Table\PatientActsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PatientActsTable Test Case
 */
class PatientActsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PatientActsTable
     */
    public $PatientActs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PatientActs') ? [] : ['className' => 'App\Model\Table\PatientActsTable'];
        $this->PatientActs = TableRegistry::get('PatientActs', $config);
    }
