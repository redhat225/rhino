...
use App\Model\Table\PatientAntecedentItemsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PatientAntecedentItemsTable Test Case
 */
class PatientAntecedentItemsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PatientAntecedentItemsTable
     */
    public $PatientAntecedentItems;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PatientAntecedentItems') ? [] : ['className' => 'App\Model\Table\PatientAntecedentItemsTable'];
        $this->PatientAntecedentItems = TableRegistry::get('PatientAntecedentItems', $config);
    }
    ...
    {
        unset($this->PatientAntecedentItems);
