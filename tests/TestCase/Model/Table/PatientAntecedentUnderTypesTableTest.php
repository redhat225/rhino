...
use App\Model\Table\PatientAntecedentUnderTypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PatientAntecedentUnderTypesTable Test Case
 */
class PatientAntecedentUnderTypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PatientAntecedentUnderTypesTable
     */
    public $PatientAntecedentUnderTypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PatientAntecedentUnderTypes') ? [] : ['className' => 'App\Model\Table\PatientAntecedentUnderTypesTable'];
        $this->PatientAntecedentUnderTypes = TableRegistry::get('PatientAntecedentUnderTypes', $config);
    }
    ...
    {
        unset($this->PatientAntecedentUnderTypes);
