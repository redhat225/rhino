...
use App\Model\Table\PatientAntecedentsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PatientAntecedentsTable Test Case
 */
class PatientAntecedentsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PatientAntecedentsTable
     */
    public $PatientAntecedents;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PatientAntecedents') ? [] : ['className' => 'App\Model\Table\PatientAntecedentsTable'];
        $this->PatientAntecedents = TableRegistry::get('PatientAntecedents', $config);
    }
