...
use App\Model\Table\PatientSchedulesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PatientSchedulesTable Test Case
 */
class PatientSchedulesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PatientSchedulesTable
     */
    public $PatientSchedules;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PatientSchedules') ? [] : ['className' => 'App\Model\Table\PatientSchedulesTable'];
        $this->PatientSchedules = TableRegistry::get('PatientSchedules', $config);
    }
