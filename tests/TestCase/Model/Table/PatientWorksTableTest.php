...
use App\Model\Table\PatientWorksTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PatientWorksTable Test Case
 */
class PatientWorksTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PatientWorksTable
     */
    public $PatientWorks;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PatientWorks') ? [] : ['className' => 'App\Model\Table\PatientWorksTable'];
        $this->PatientWorks = TableRegistry::get('PatientWorks', $config);
    }
