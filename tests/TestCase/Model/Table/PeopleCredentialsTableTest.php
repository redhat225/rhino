...
use App\Model\Table\PeopleCredentialsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PeopleCredentialsTable Test Case
 */
class PeopleCredentialsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PeopleCredentialsTable
     */
    public $PeopleCredentials;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PeopleCredentials') ? [] : ['className' => 'App\Model\Table\PeopleCredentialsTable'];
        $this->PeopleCredentials = TableRegistry::get('PeopleCredentials', $config);
    }
