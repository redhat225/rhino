...
use App\Model\Table\RequirementHolderDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementHolderDetailsTable Test Case
 */
class RequirementHolderDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementHolderDetailsTable
     */
    public $RequirementHolderDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementHolderDetails') ? [] : ['className' => 'App\Model\Table\RequirementHolderDetailsTable'];
        $this->RequirementHolderDetails = TableRegistry::get('RequirementHolderDetails', $config);
    }
    ...
    {
        unset($this->RequirementHolderDetails);
