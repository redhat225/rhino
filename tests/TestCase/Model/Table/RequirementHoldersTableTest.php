...
use App\Model\Table\RequirementHoldersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementHoldersTable Test Case
 */
class RequirementHoldersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementHoldersTable
     */
    public $RequirementHolders;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementHolders') ? [] : ['className' => 'App\Model\Table\RequirementHoldersTable'];
        $this->RequirementHolders = TableRegistry::get('RequirementHolders', $config);
    }
