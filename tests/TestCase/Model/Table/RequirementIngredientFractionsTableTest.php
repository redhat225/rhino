...
use App\Model\Table\RequirementIngredientFractionsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementIngredientFractionsTable Test Case
 */
class RequirementIngredientFractionsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementIngredientFractionsTable
     */
    public $RequirementIngredientFractions;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementIngredientFractions') ? [] : ['className' => 'App\Model\Table\RequirementIngredientFractionsTable'];
        $this->RequirementIngredientFractions = TableRegistry::get('RequirementIngredientFractions', $config);
    }
    ...
    {
        unset($this->RequirementIngredientFractions);
