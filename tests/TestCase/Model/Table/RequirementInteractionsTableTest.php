...
use App\Model\Table\RequirementInteractionsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementInteractionsTable Test Case
 */
class RequirementInteractionsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementInteractionsTable
     */
    public $RequirementInteractions;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementInteractions') ? [] : ['className' => 'App\Model\Table\RequirementInteractionsTable'];
        $this->RequirementInteractions = TableRegistry::get('RequirementInteractions', $config);
    }
    ...
    {
        unset($this->RequirementInteractions);
