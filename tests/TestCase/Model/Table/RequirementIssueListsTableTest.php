...
use App\Model\Table\RequirementIssueListsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementIssueListsTable Test Case
 */
class RequirementIssueListsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementIssueListsTable
     */
    public $RequirementIssueLists;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementIssueLists') ? [] : ['className' => 'App\Model\Table\RequirementIssueListsTable'];
        $this->RequirementIssueLists = TableRegistry::get('RequirementIssueLists', $config);
    }
    ...
    {
        unset($this->RequirementIssueLists);
