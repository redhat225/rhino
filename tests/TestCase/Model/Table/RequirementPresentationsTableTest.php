...
use App\Model\Table\RequirementPresentationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementPresentationsTable Test Case
 */
class RequirementPresentationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementPresentationsTable
     */
    public $RequirementPresentations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementPresentations') ? [] : ['className' => 'App\Model\Table\RequirementPresentationsTable'];
        $this->RequirementPresentations = TableRegistry::get('RequirementPresentations', $config);
    }
    ...
    {
        unset($this->RequirementPresentations);
