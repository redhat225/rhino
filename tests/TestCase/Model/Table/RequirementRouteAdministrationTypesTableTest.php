...
use App\Model\Table\RequirementRouteAdministrationTypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementRouteAdministrationTypesTable Test Case
 */
class RequirementRouteAdministrationTypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementRouteAdministrationTypesTable
     */
    public $RequirementRouteAdministrationTypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementRouteAdministrationTypes') ? [] : ['className' => 'App\Model\Table\RequirementRouteAdministrationTypesTable'];
        $this->RequirementRouteAdministrationTypes = TableRegistry::get('RequirementRouteAdministrationTypes', $config);
    }
    ...
    {
        unset($this->RequirementRouteAdministrationTypes);
