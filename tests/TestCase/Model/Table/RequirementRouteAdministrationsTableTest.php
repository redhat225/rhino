...
use App\Model\Table\RequirementRouteAdministrationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementRouteAdministrationsTable Test Case
 */
class RequirementRouteAdministrationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementRouteAdministrationsTable
     */
    public $RequirementRouteAdministrations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementRouteAdministrations') ? [] : ['className' => 'App\Model\Table\RequirementRouteAdministrationsTable'];
        $this->RequirementRouteAdministrations = TableRegistry::get('RequirementRouteAdministrations', $config);
    }
    ...
    {
        unset($this->RequirementRouteAdministrations);
