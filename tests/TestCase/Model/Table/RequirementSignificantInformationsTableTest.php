...
use App\Model\Table\RequirementSignificantInformationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\RequirementSignificantInformationsTable Test Case
 */
class RequirementSignificantInformationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\RequirementSignificantInformationsTable
     */
    public $RequirementSignificantInformations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('RequirementSignificantInformations') ? [] : ['className' => 'App\Model\Table\RequirementSignificantInformationsTable'];
        $this->RequirementSignificantInformations = TableRegistry::get('RequirementSignificantInformations', $config);
    }
    ...
    {
        unset($this->RequirementSignificantInformations);
