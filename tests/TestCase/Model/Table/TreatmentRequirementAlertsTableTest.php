...
use App\Model\Table\TreatmentRequirementAlertsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TreatmentRequirementAlertsTable Test Case
 */
class TreatmentRequirementAlertsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TreatmentRequirementAlertsTable
     */
    public $TreatmentRequirementAlerts;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TreatmentRequirementAlerts') ? [] : ['className' => 'App\Model\Table\TreatmentRequirementAlertsTable'];
        $this->TreatmentRequirementAlerts = TableRegistry::get('TreatmentRequirementAlerts', $config);
    }
    ...
    {
        unset($this->TreatmentRequirementAlerts);
