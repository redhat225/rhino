...
use App\Model\Table\TreatmentRequirementRenewalsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TreatmentRequirementRenewalsTable Test Case
 */
class TreatmentRequirementRenewalsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TreatmentRequirementRenewalsTable
     */
    public $TreatmentRequirementRenewals;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TreatmentRequirementRenewals') ? [] : ['className' => 'App\Model\Table\TreatmentRequirementRenewalsTable'];
        $this->TreatmentRequirementRenewals = TableRegistry::get('TreatmentRequirementRenewals', $config);
    }
    ...
    {
        unset($this->TreatmentRequirementRenewals);
