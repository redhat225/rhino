...
use App\Model\Table\TreatmentRequirementSpecificationsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TreatmentRequirementSpecificationsTable Test Case
 */
class TreatmentRequirementSpecificationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TreatmentRequirementSpecificationsTable
     */
    public $TreatmentRequirementSpecifications;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TreatmentRequirementSpecifications') ? [] : ['className' => 'App\Model\Table\TreatmentRequirementSpecificationsTable'];
        $this->TreatmentRequirementSpecifications = TableRegistry::get('TreatmentRequirementSpecifications', $config);
    }
    ...
    {
        unset($this->TreatmentRequirementSpecifications);
