...
use App\Model\Table\VisitActAuxiliaryDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitActAuxiliaryDetailsTable Test Case
 */
class VisitActAuxiliaryDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitActAuxiliaryDetailsTable
     */
    public $VisitActAuxiliaryDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitActAuxiliaryDetails') ? [] : ['className' => 'App\Model\Table\VisitActAuxiliaryDetailsTable'];
        $this->VisitActAuxiliaryDetails = TableRegistry::get('VisitActAuxiliaryDetails', $config);
    }
    ...
    {
        unset($this->VisitActAuxiliaryDetails);
