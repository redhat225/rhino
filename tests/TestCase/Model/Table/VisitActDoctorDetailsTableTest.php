...
use App\Model\Table\VisitActDoctorDetailsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitActDoctorDetailsTable Test Case
 */
class VisitActDoctorDetailsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitActDoctorDetailsTable
     */
    public $VisitActDoctorDetails;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitActDoctorDetails') ? [] : ['className' => 'App\Model\Table\VisitActDoctorDetailsTable'];
        $this->VisitActDoctorDetails = TableRegistry::get('VisitActDoctorDetails', $config);
    }
    ...
    {
        unset($this->VisitActDoctorDetails);
