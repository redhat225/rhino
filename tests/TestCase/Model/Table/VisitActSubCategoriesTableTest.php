...
use App\Model\Table\VisitActSubCategoriesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitActSubCategoriesTable Test Case
 */
class VisitActSubCategoriesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitActSubCategoriesTable
     */
    public $VisitActSubCategories;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitActSubCategories') ? [] : ['className' => 'App\Model\Table\VisitActSubCategoriesTable'];
        $this->VisitActSubCategories = TableRegistry::get('VisitActSubCategories', $config);
    }
    ...
    {
        unset($this->VisitActSubCategories);
