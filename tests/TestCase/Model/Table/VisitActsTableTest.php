...
use App\Model\Table\VisitActsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitActsTable Test Case
 */
class VisitActsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitActsTable
     */
    public $VisitActs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitActs') ? [] : ['className' => 'App\Model\Table\VisitActsTable'];
        $this->VisitActs = TableRegistry::get('VisitActs', $config);
    }
