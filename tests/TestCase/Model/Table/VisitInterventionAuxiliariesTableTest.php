...
use App\Model\Table\VisitInterventionAuxiliariesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitInterventionAuxiliariesTable Test Case
 */
class VisitInterventionAuxiliariesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitInterventionAuxiliariesTable
     */
    public $VisitInterventionAuxiliaries;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitInterventionAuxiliaries') ? [] : ['className' => 'App\Model\Table\VisitInterventionAuxiliariesTable'];
        $this->VisitInterventionAuxiliaries = TableRegistry::get('VisitInterventionAuxiliaries', $config);
    }
    ...
    {
        unset($this->VisitInterventionAuxiliaries);
