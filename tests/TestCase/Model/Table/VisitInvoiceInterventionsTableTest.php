...
use App\Model\Table\VisitInvoiceInterventionsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitInvoiceInterventionsTable Test Case
 */
class VisitInvoiceInterventionsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitInvoiceInterventionsTable
     */
    public $VisitInvoiceInterventions;
     ...
     */
    public $fixtures = [
        'app.visit_invoice_interventions',
        'app.visit_interventions',
        'app.visit_invoices',
        'app.visits',
        'app.patients',
        'app.people',
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitInvoiceInterventions') ? [] : ['className' => 'App\Model\Table\VisitInvoiceInterventionsTable'];
        $this->VisitInvoiceInterventions = TableRegistry::get('VisitInvoiceInterventions', $config);
    }
    ...
    {
        unset($this->VisitInvoiceInterventions);
