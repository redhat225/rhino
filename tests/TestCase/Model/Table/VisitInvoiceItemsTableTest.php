...
use App\Model\Table\VisitInvoiceItemsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitInvoiceItemsTable Test Case
 */
class VisitInvoiceItemsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitInvoiceItemsTable
     */
    public $VisitInvoiceItems;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitInvoiceItems') ? [] : ['className' => 'App\Model\Table\VisitInvoiceItemsTable'];
        $this->VisitInvoiceItems = TableRegistry::get('VisitInvoiceItems', $config);
    }
