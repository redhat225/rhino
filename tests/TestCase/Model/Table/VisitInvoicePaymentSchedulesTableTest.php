...
use App\Model\Table\VisitInvoicePaymentSchedulesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitInvoicePaymentSchedulesTable Test Case
 */
class VisitInvoicePaymentSchedulesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitInvoicePaymentSchedulesTable
     */
    public $VisitInvoicePaymentSchedules;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitInvoicePaymentSchedules') ? [] : ['className' => 'App\Model\Table\VisitInvoicePaymentSchedulesTable'];
        $this->VisitInvoicePaymentSchedules = TableRegistry::get('VisitInvoicePaymentSchedules', $config);
    }
    ...
    {
        unset($this->VisitInvoicePaymentSchedules);
