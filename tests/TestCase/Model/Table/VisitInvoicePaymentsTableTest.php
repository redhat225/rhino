...
use App\Model\Table\VisitInvoicePaymentsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitInvoicePaymentsTable Test Case
 */
class VisitInvoicePaymentsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitInvoicePaymentsTable
     */
    public $VisitInvoicePayments;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitInvoicePayments') ? [] : ['className' => 'App\Model\Table\VisitInvoicePaymentsTable'];
        $this->VisitInvoicePayments = TableRegistry::get('VisitInvoicePayments', $config);
    }
    ...
    {
        unset($this->VisitInvoicePayments);
