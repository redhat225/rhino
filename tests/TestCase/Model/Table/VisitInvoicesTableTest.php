...
use App\Model\Table\VisitInvoicesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitInvoicesTable Test Case
 */
class VisitInvoicesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitInvoicesTable
     */
    public $VisitInvoices;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitInvoices') ? [] : ['className' => 'App\Model\Table\VisitInvoicesTable'];
        $this->VisitInvoices = TableRegistry::get('VisitInvoices', $config);
    }
