...
use App\Model\Table\VisitMeetingConstantsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitMeetingConstantsTable Test Case
 */
class VisitMeetingConstantsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitMeetingConstantsTable
     */
    public $VisitMeetingConstants;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitMeetingConstants') ? [] : ['className' => 'App\Model\Table\VisitMeetingConstantsTable'];
        $this->VisitMeetingConstants = TableRegistry::get('VisitMeetingConstants', $config);
    }
    ...
    {
        unset($this->VisitMeetingConstants);
