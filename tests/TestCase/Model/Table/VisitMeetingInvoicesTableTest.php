...
use App\Model\Table\VisitMeetingInvoicesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitMeetingInvoicesTable Test Case
 */
class VisitMeetingInvoicesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitMeetingInvoicesTable
     */
    public $VisitMeetingInvoices;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitMeetingInvoices') ? [] : ['className' => 'App\Model\Table\VisitMeetingInvoicesTable'];
        $this->VisitMeetingInvoices = TableRegistry::get('VisitMeetingInvoices', $config);
    }
    ...
    {
        unset($this->VisitMeetingInvoices);
