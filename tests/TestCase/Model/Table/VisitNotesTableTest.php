...
use App\Model\Table\VisitNotesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitNotesTable Test Case
 */
class VisitNotesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitNotesTable
     */
    public $VisitNotes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitNotes') ? [] : ['className' => 'App\Model\Table\VisitNotesTable'];
        $this->VisitNotes = TableRegistry::get('VisitNotes', $config);
    }
