...
use App\Model\Table\VisitSpecialitiesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitSpecialitiesTable Test Case
 */
class VisitSpecialitiesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitSpecialitiesTable
     */
    public $VisitSpecialities;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitSpecialities') ? [] : ['className' => 'App\Model\Table\VisitSpecialitiesTable'];
        $this->VisitSpecialities = TableRegistry::get('VisitSpecialities', $config);
    }
