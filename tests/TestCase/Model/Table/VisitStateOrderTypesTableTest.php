...
use App\Model\Table\VisitStateOrderTypesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitStateOrderTypesTable Test Case
 */
class VisitStateOrderTypesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitStateOrderTypesTable
     */
    public $VisitStateOrderTypes;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitStateOrderTypes') ? [] : ['className' => 'App\Model\Table\VisitStateOrderTypesTable'];
        $this->VisitStateOrderTypes = TableRegistry::get('VisitStateOrderTypes', $config);
    }
    ...
    {
        unset($this->VisitStateOrderTypes);
