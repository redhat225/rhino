...
use App\Model\Table\VisitStatesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\VisitStatesTable Test Case
 */
class VisitStatesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\VisitStatesTable
     */
    public $VisitStates;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('VisitStates') ? [] : ['className' => 'App\Model\Table\VisitStatesTable'];
        $this->VisitStates = TableRegistry::get('VisitStates', $config);
    }
